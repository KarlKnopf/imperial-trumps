...
const tableauDiv = document.getElementById("tableau-container");
const foundationsDiv = document.getElementById("foundations-container");
...
["keys","cups","swords","pentacles","major"].forEach(suit => {
